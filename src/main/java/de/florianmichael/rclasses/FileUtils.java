...
public final class FileUtils {
    ...
    public static File download(final String url, final File output) throws Throwable {
        return download(url, DEFAULT_AGENT, output);
    }

    public static File download(final String url, final String agent, final File output) throws Throwable {
