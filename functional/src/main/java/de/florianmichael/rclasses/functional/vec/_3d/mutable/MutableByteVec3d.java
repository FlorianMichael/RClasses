...
public class MutableByteVec3d extends ShortVec3d {
    ...
    public MutableByteVec3d(final short x, final short y, final short z) {
        this.x = x;
        this.y = y;
        this.z = z;
    }
    ...
    public boolean equals(Object o) {
        ...
        MutableByteVec3d that = (MutableByteVec3d) o;
